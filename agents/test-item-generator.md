...
- 因子に「ワンパス」というワードを含む因子の水準は組み合わせに含めず、組み合わせの最後に1ケースずつ記載すること
- 組み合わせ数が300を超える場合は上限まで記載し警告を出力
...
### 5. 同一内容のセルを結合する
- mcp__mcp-google-drive__g_drive_read_file_part ツールでB:Fの範囲を読み取り、縦に同じ文字列が連続しているセルを見つけてください
