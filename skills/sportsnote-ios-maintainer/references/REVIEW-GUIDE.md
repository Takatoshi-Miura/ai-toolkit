...
prompt: |
  SportsNote iOSの実装をクロスレビューしてください。あなたは実装者ではなく、独立したレビュアーです。
  ...
  ## 参照情報
  - コーディング規約: /Users/it6210/Documents/Git/SportsNote_iOS/CLAUDE.md
  - 過去の指摘パターン: /Users/it6210/.claude/skills/sportsnote-ios-maintainer/references/review-insights.md
