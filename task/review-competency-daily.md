# review-competency-daily コマンド用タスク

## 概要
前日のClaude Code使用履歴を分析し、コンピテンシー評価基準に照らし合わせて該当する行動があったかを判定する。
...
### Phase 2: コンピテンシー評価基準の読み取り

**参照タスク**: `~/Documents/Git/ai-toolkit/task/read-google-drive.md`

3. 上記タスクに従って、コンピテンシー評価基準ドキュメントを読み取る
   - URL: https://docs.google.com/document/d/1iVeZ1EB5dahEZukuQQB4gSa5jIw3By-Gz8JaAysiAoA/edit
   - File ID: `1iVeZ1EB5dahEZukuQQB4gSa5jIw3By-Gz8JaAysiAoA`
   - 「今年の目標」タブ内の「仕事:コンピテンシー評価基準」セクションを読み取る
...
### Phase 3: 履歴と評価基準のマッピング

5. 活動内容を評価基準に照らし合わせて分類する

   前日の各セッションについて、以下の一般的な観点で分析:
